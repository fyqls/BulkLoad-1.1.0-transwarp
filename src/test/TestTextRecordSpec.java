...
public class TestTextRecordSpec {
	...
	public void testSimpleSpec() {
		...
		TextRecordSpec spec = new TextRecordSpec("firstName:STRING,secondName,age:INT");
		
		assertTrue("[0:firstName:STRING, 1:secondName:STRING, 2:age:INT]".equals(spec.toString()));
		
		TextRecordSpec spec2 = new TextRecordSpec("firstName :string , secondName,age :int");
		
		assertTrue("[0:firstName:STRING, 1:secondName:STRING, 2:age:INT]".equals(spec2.toString()));

		TextRecordSpec spec3 = new TextRecordSpec("firstName:String,secondName,age:INT");
		
		assertTrue("[0:firstName:STRING, 1:secondName:STRING, 2:age:INT]".equals(spec3.toString()));
