...
public class CombineRemoteFileLineRecordReader extends RecordReader<MultiFileInputWritableComparable, Text> {
	...
	public CombineRemoteFileLineRecordReader(CombineFileSplit split, TaskAttemptContext context, Integer index) throws IOException 
	{
